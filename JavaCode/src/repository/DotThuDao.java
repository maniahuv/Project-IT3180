...
public class DotThuDao extends DataAccessObject<DotThu> {
	...
	public int updateDotThu(DotThu dt) {
        ...
        Object[] vals = {
            dt.getTenDotThu(),
            dt.getThoiGianBatDau(),
            dt.getThoiGianKetThuc(),
            dt.getMoTa(),
            dt.getTrangThai()  
        };
	...
	public List<DotThu> timDotThuTheoTieuChi(
            String tenDotThu,
            String moTa,
            Date tuNgay,
            Date denNgay,
	...
	public ThongKeDotThu thongKeDotThu() {
        String sql =
            "SELECT " +
            "  COUNT(*)                 AS total, " +
            "  SUM(CASE WHEN trang_thai=0 THEN 1 ELSE 0 END) AS DangDienRa, " +
            "  SUM(CASE WHEN trang_thai=1 THEN 1 ELSE 0 END) AS DaDienRa" +
            "FROM DotThu";
